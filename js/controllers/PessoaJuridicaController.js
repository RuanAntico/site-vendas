/**
 * PessoaJuridicaController - Controla a lógica do formulário de Pessoa Jurídica
 */
class PessoaJuridicaController {
    ...
    /**
     * Processa a adição de dados de pessoa jurídica
     */
    async handleAdicionarDados() {
        ...
        // Adiciona os dados à pessoa jurídica atual
        ...
        // Salva os dados
        const resultado = await this.sistema.adicionarPessoaJuridica(dados);
        ...
        if (resultado.sucesso) {
            const resultadoPedido = await this.sistema.adicionarPedido(
                ...
                1,
                0,
                `Pedido gerado a partir do formulario de Pessoa Juridica (${this.sistema.nomeServicoAtual || 'Servico'})`,
                { pessoa_tipo: 'juridica', pessoa_ref_id: resultado.id || null }
            );
